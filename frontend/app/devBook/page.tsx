...
// Definir una interfaz para el tipo de datos de un libro
interface Book {
  id: number;
  title: string;
  author: string;
...
function BookCard({ book }: { book: Book }) {
  ...
  return (
    ...
    >
      {flipped ? (
        <div className="absolute w-full h-full bg-gradient-to-b from-[#f7f3ee] to-[#e4ded7] border border-[#B59DA4] rounded-lg shadow-md flex items-center justify-center p-4">
          <p className="text-[#6D3D14] text-center text-sm">{book.description}</p>
        </div>
      ) : (
        <div className="absolute w-full h-full bg-gradient-to-b from-[#f7f3ee] to-[#e4ded7] border border-[#B59DA4] rounded-lg shadow-md flex flex-col items-center">
          <img
            src={book.image}
            alt={book.title}
  ...
  const books: Book[] = [
    {
      ...
      description: "Una novela distópica sobre un régimen totalitario y la vigilancia constante.",
    },
    {
      id: 2,
      title: "Un mundo feliz",
      author: "Aldous Huxley",
      image: "https://m.media-amazon.com/images/I/41Qb8TJtPuL._SY445_SX342_.jpg",
      description: "Una sociedad futurista donde la felicidad se controla artificialmente.",
    },
    {
      id: 3,
      title: "Las aventuras de Huckleberry Finn",
      author: "Mark Twain",
      image: "https://m.media-amazon.com/images/I/51Lx-8BHQYL._SY445_SX342_.jpg",
      description: "Un relato clásico sobre la amistad y la libertad en el río Mississippi.",
    },
    {
      id: 4,
      title: "El amante de Lady Chatterley",
      author: "D. H. Lawrence",
      image: "https://m.media-amazon.com/images/I/41lm2uusjTL._SY445_SX342_.jpg",
      description: "Una historia de amor prohibido en la Inglaterra de principios del siglo XX.",
    },
    {
      id: 5,
      title: "Cometierra",
      author: "Dolores Reyes",
      image: "https://m.media-amazon.com/images/I/81CS23nAbrL._SY522_.jpg",
      description: "Una novela sobre violencia de género y justicia en el contexto argentino.",
    },
  ];
